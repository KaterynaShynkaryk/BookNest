...
class BookListViewTest(TestCase):
    ...
    def test_book_show_status_badges_and_displayed_count(self):
        ...
        self.assertContains(response, 'href="#icon-favorite"')
        self.assertContains(response, 'href="#icon-favorite-border"')
...
class ShelfListViewTests(TestCase):
    ...
    def test_shelf_list_shows_only_current_users_shelves_and_books(self):
        ...
        self.assertContains(response, 'href="#icon-library-books"')
...
class NoteFeatureTests(TestCase):
    ...
    def test_general_notes_page_creates_and_lists_general_and_book_notes(self):
        ...
        self.assertContains(response, "Бібліотека")
        self.assertContains(response, "Нотатки")
        self.assertContains(response, "Полички")
        self.assertContains(response, 'href="#icon-library"')
        self.assertContains(response, 'href="#icon-notes"')
        self.assertContains(response, 'href="#icon-shelves"')
